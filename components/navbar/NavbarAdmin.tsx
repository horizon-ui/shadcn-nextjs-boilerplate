...
export default function AdminNavbar(props: {
  ...
  return (
    <nav
      className={`fixed right-3 top-3 z-[100] flex w-[calc(100vw_-_6%)] flex-wrap items-center justify-between rounded-lg bg-white/30 py-2 backdrop-blur-xl transition-all dark:bg-transparent md:right-[30px] md:top-4 md:w-[calc(100vw_-_8%)] md:p-2 lg:w-[calc(100vw_-_6%)] xl:top-[20px] xl:w-[calc(100vw_-_365px)] 2xl:w-[calc(100vw_-_380px)]`}
    >
      <div className="ml-[6px]">
        <div className="h-6 md:mb-2 md:w-[224px] md:pt-1">
          <a
            className="text-xs font-normal text-zinc-950 hover:underline dark:text-white dark:hover:text-white md:inline"
            href=""
          >
            Pages
      ...
      <div className="mt-2 w-[154px] min-w-max md:ml-auto md:mt-0 md:w-[unset]">
        <AdminNavbarLinks
          onOpen={onOpen}
